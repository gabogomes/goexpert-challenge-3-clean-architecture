...
type OrderServiceClient interface {
	...
	GetAllOrders(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*GetAllOrdersResponse, error)
}
...
func (c *orderServiceClient) GetAllOrders(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*GetAllOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{}, opts...)
...
type OrderServiceServer interface {
	...
	GetAllOrders(context.Context, *EmptyRequest) (*GetAllOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) GetAllOrders(context.Context, *EmptyRequest) (*GetAllOrdersResponse, error) {
...
func _OrderService_GetAllOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetAllOrders(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
